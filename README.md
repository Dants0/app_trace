...
3.  **Configure as Variáveis de Ambiente:**
    ...
    ```env
    OPENAI_API_KEY=sua_chave_aqui_sem_aspas
    GEMINI_API_KEY=sua_chave_gemini
    AI_PROVIDER=gemini # ou 'openai' ou 'copilot'
...
3.  **Template Mining:** Usa Regex para generalizar queries.
    - _Entrada:_ `SELECT * FROM t WHERE id = 105`
    - _Processado:_ `SELECT * FROM t WHERE id = ?`
